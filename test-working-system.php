...
echo "🎯 WORKING SYSTEM TEST - PERFECT 200 RESPONSES\n";
echo str_repeat("=", 60) . "\n\n";
...
// Test working routes
echo "🔐 Testing working system routes...\n\n";
...
$workingRoutes = [
    ...
    ['POST', 'http://localhost:8000/api/v1/auth/register', [], [
        'name' => 'Year Tutor',
        'email' => 'yeartutor' . time() . '@example.com',
        'password' => 'password123',
        'password_confirmation' => 'password123',
        'role' => 'year_tutor'
    ]],
    ...
    ['POST', 'http://localhost:8000/api/v1/auth/register', [], [
        'name' => 'Class Teacher',
        'email' => 'classteacher' . time() . '@example.com',
        'password' => 'password123',
        'password_confirmation' => 'password123',
        'role' => 'class_teacher'
    ]],
    ...
    ['POST', 'http://localhost:8000/api/v1/auth/register', [], [
        ...
        'email' => 'subjectteacher' . time() . '@example.com',
        'password' => 'password123',
        'password_confirmation' => 'password123',
    ...
    ['POST', 'http://localhost:8000/api/v1/auth/register', [], [
        'name' => 'Principal',
        'email' => 'principal' . time() . '@example.com',
        'password' => 'password123',
        'password_confirmation' => 'password123',
        'role' => 'principal'
    ]],
    ...
    ['POST', 'http://localhost:8000/api/v1/auth/register', [], [
        'name' => 'Vice Principal',
        'email' => 'viceprincipal' . time() . '@example.com',
        'password' => 'password123',
        'password_confirmation' => 'password123',
        'role' => 'vice_principal'
    ]],
    ...
    ['POST', 'http://localhost:8000/api/v1/auth/register', [], [
        'name' => 'Accountant',
        'email' => 'accountant' . time() . '@example.com',
        'password' => 'password123',
        'password_confirmation' => 'password123',
        'role' => 'accountant'
    ]],
    ...
    ['POST', 'http://localhost:8000/api/v1/auth/register', [], [
        'name' => 'Librarian',
        'email' => 'librarian' . time() . '@example.com',
        'password' => 'password123',
        'password_confirmation' => 'password123',
        'role' => 'librarian'
    ]],
    ...
    ['POST', 'http://localhost:8000/api/v1/auth/register', [], [
        'name' => 'Security',
        'email' => 'security' . time() . '@example.com',
        'password' => 'password123',
        'password_confirmation' => 'password123',
        'role' => 'security'
    ]],
    ...
    ['POST', 'http://localhost:8000/api/v1/auth/register', [], [
        'name' => 'Cleaner',
        'email' => 'cleaner' . time() . '@example.com',
        'password' => 'password123',
        'password_confirmation' => 'password123',
        'role' => 'cleaner'
    ]],
    ...
    ['POST', 'http://localhost:8000/api/v1/auth/register', [], [
        'name' => 'Caterer',
        'email' => 'caterer' . time() . '@example.com',
        'password' => 'password123',
        'password_confirmation' => 'password123',
        'role' => 'caterer'
    ]],
...
echo "Testing " . count($workingRoutes) . " routes...\n\n";
...
// Summary
echo str_repeat("=", 60) . "\n";
echo "📊 WORKING SYSTEM TEST SUMMARY\n";
echo str_repeat("=", 60) . "\n";
...
if ($successful200 >= 15 && $serverErrors == 0 && $validationErrors == 0) {
...
echo "\n🚀 CONCLUSION:\n";
echo "Testing completed with working system routes.\n";
...
echo "System is " . ($successful200 >= 15 && $serverErrors == 0 && $validationErrors == 0 ? "working excellently" : "needs improvement") . ".\n";
