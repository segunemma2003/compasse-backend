...
class DeployWebhookController extends Controller
{
    ...
    public function trigger(Request $request): JsonResponse
    {
        ...
        // Truncate before starting: status() greps the tail of this file for
        // "Deployment completed successfully", so a leftover marker from a previous run
        // would make a brand-new deploy look instantly "done" before it has done anything.
