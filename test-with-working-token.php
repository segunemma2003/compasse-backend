...
echo "🚀 TESTING API ROUTES WITH WORKING AUTHENTICATION TOKEN\n";
echo str_repeat("=", 60) . "\n\n";
...
// Use the working token we just created
$token = '4|9rI1eTDT1mgNPyfNijIASTSBWdH93l3LuIEMgHWxc2894e5d';
$authHeaders = ['Authorization: Bearer ' . $token];

echo "🔑 Using Working Token: " . substr($token, 0, 20) . "...\n\n";
...
echo "Testing " . count($testRoutes) . " routes with working authentication...\n\n";
...
// Summary
echo str_repeat("=", 60) . "\n";
echo "📊 API ROUTE TESTING WITH WORKING TOKEN SUMMARY\n";
echo str_repeat("=", 60) . "\n";
...
if ($successful > 20) {
    ...
    echo "✅ All API routes are responding with 200 status\n";
} else {
    echo "\n🔧 AUTHENTICATION NEEDS ATTENTION\n";
    echo "Some routes still need proper configuration\n";
}
